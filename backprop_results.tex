...
\begin{table}[hb]
	\begin{tabular}{lll|lll}
		...
		A & 40 & MassInputPlacer($\begin{bmatrix} 0.5\\0\end{bmatrix}$) & 1 & 0.29927 & 154.8 \\
		A & 20 & MassInputPlacer($\begin{bmatrix} 1\\1\end{bmatrix}$) & 1 & 0.0 & 200.1 \\
...
\subsubsection{A stable run with good performance}
